          ...
          <div class="card-body">
            <form action="{{ route('info.add') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="email" name="email" required class="form-control title" id="basic-default-fullname" placeholder="email">
              </div>
              <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">Mobile</label>
                <input type="number" name="mobile" class="form-control title" required id="basic-default-fullname" placeholder="Mobile Number">
              </div>
              <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">facebook page Link</label>
                <input type="text" name="fb" class="form-control title" id="basic-default-fullname" placeholder="https://facebook.com/pagename">
              </div>
              <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">CopyRight</label>
                <input type="text" name="copyright" class="form-control title" id="basic-default-fullname" placeholder="copyright">
              </div>
              <div class="mb-3">
