        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('gallery.view') }}" class="menu-link" target="_blank">
                    <div data-i18n="Basic">Gallery View</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('gallery.add') }}" class="menu-link" target="_blank">
                    <div data-i18n="Basic">Add Gallery Info</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('gallery.image') }}" class="menu-link" target="_blank">
                    <div data-i18n="Basic">Insert Gallery Image</div>
                  </a>
                </li>
              </ul>
            </li>
